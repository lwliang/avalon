...
@ControllerAdvice
@Slf4j
public class FileControllerAdvice implements ResponseBodyAdvice<Object> {
    ...
    public Map errorHandler(HttpServletRequest req, HttpServletResponse response, Exception ex) {
        Map map = new HashMap();
        Integer code = 0;
        response.setStatus(500);
        if (ex instanceof IAvalonException) {
