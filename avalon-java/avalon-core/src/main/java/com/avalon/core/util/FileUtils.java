...
public class FileUtils {
    ...
    public static ArrayList<File> getFiles(File file) {
        ...
        for (File value : tempList) {
            ...
            if (value.isDirectory()) {
                ArrayList<File> files1 = getFiles(value);
                files.addAll(files1);
            }
        }
        return files;
     ...
     */
    public static byte[] readFileByBytes(InputStream in) throws IOException {
        byte[] bytes = null;
        try {
     ...
     * @param content
     */
    public static void writeIntoOut(String fileName, byte[] content) throws IOException {
     ...
     * @return
     */
    public static File createTempFileFromResource(String fileName, String ext, String classPath)
            throws IOException {
